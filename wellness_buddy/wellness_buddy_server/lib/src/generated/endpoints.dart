...
import 'package:wellness_buddy_server/src/generated/chat_message.dart' as _i7;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
        ...
        'sendMessage': _i1.MethodConnector(
          ...
          params: {
            'history': _i1.ParameterDescription(
              name: 'history',
              type: _i1.getType<List<_i7.ChatMessage>>(),
              nullable: false,
            ),
    ...
    connectors['journal'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'analyzeJournal': _i1.MethodConnector(
          name: 'analyzeJournal',
          params: {
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['journal'] as _i5.JournalEndpoint).analyzeJournal(
                    session,
                    params['text'],
                  ),
        ),
