...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:wellness_buddy_server/src/generated/chat_message.dart' as _i5;
import 'package:wellness_buddy_server/src/generated/journal_analysis.dart'
    as _i6;
import 'package:wellness_buddy_server/src/generated/greetings/greeting.dart'
    as _i7;
import 'package:wellness_buddy_server/src/generated/protocol.dart';
import 'package:wellness_buddy_server/src/generated/endpoints.dart';
...
class _JournalEndpoint {
  ...
  _i3.Future<_i6.JournalAnalysis> analyzeJournal(
    _i1.TestSessionBuilder sessionBuilder,
    String text,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'journal',
            method: 'analyzeJournal',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'journal',
          methodName: 'analyzeJournal',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.JournalAnalysis>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
